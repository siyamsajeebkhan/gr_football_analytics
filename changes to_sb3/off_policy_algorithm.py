...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def learn(
        ...
        print("---> OffpolicyAlgorithm.learn():")
        # print(f"self = {self}")
    ...
    def _sample_action(
        ...
        if isinstance(self.action_space, gym.spaces.Box):
            ...
            # print(f"Working with Discrete actions")
    ...
    def collect_rollouts(
        ...
        # print(f"Outside of steps collection when num_collected_steps={num_collected_steps}")
